...
public class GeneMedFillDetailsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static final Logger log = Logger.getLogger(GeneMedFillDetailsServlet.class);
	public GeneMedFillDetailsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("GeneMedDetailsList.jsp");
