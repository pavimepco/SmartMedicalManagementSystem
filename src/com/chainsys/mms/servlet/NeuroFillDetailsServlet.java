...
public class NeuroFillDetailsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static final Logger log = Logger.getLogger(NeuroFillDetailsServlet.class);
	public NeuroFillDetailsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("NeuroDetailsList.jsp");
