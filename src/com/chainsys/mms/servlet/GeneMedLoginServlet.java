...
public class GeneMedLoginServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 
		static final Logger log = Logger.getLogger(GeneMedLoginServlet.class);  
   
    public GeneMedLoginServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (b) {
			RequestDispatcher rd = request.getRequestDispatcher("GeneMedFillDetails.jsp");
