...
public class OrthoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static final Logger log = Logger.getLogger(OrthoServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (b) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("OrthoSymptom.jsp");
