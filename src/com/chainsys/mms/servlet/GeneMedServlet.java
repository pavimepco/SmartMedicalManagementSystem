...
public class GeneMedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static final Logger log = Logger.getLogger(GeneMedServlet.class);

	public GeneMedServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (b) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("GeneMedSymptom.jsp");
