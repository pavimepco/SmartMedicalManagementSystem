...
public class NeuroLoginServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 
		static final Logger log = Logger.getLogger(NeuroLoginServlet.class);  
   
    public NeuroLoginServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (b) {
			RequestDispatcher rd = request.getRequestDispatcher("NeuroFillDetails.jsp");
