...
SET DEFINE OFF;
Insert into HR.TRN_CUSTOMERS (ACCOUNT_NUMBER,CUSTOMER_NAME,CUSTOMER_ID,EMAIL,PHONE_NUMBER,FATHERS_NAME,GENDER,BALANCE,USERNAME,PASSWORD,DOB,PERMANENT_ADDRESS,PERMANENT_CITY,CURRENT_ADDRESS,CURRENT_CITY,STATE,IFSC_CODE,FLAG,CREATED_DATE,MODIFIED_DATE,MMID) values (620410100000,'Athiselvam',5000,'athitek@rediffmail.com',9042401691,'Nainar','Male',34500,'its773','pass123',to_date('11-05-97','DD-MM-RR'),'shanmugam street','shencottai','shanmugam street','shencottai','Tamil nadu','ATEK000138',1,to_timestamp('21-05-19 05:08:18.430000000 PM','DD-MM-RR HH12:MI:SSXFF AM'),to_timestamp('21-05-19 05:08:18.430000000 PM','DD-MM-RR HH12:MI:SSXFF AM'),8807651);
Insert into HR.TRN_CUSTOMERS (ACCOUNT_NUMBER,CUSTOMER_NAME,CUSTOMER_ID,EMAIL,PHONE_NUMBER,FATHERS_NAME,GENDER,BALANCE,USERNAME,PASSWORD,DOB,PERMANENT_ADDRESS,PERMANENT_CITY,CURRENT_ADDRESS,CURRENT_CITY,STATE,IFSC_CODE,FLAG,CREATED_DATE,MODIFIED_DATE,MMID) values (620410100001,'Saranya',5001,'saranya@gmail.com',7010770107,'Rajagopal','Female',486000,'Saranya57','pass555',to_date('05-07-98','DD-MM-RR'),'1st street','Madurai','1st street','Madurai','Tamil nadu','ATEK000134',1,to_timestamp('21-05-19 05:13:03.113000000 PM','DD-MM-RR HH12:MI:SSXFF AM'),to_timestamp('21-05-19 05:13:03.113000000 PM','DD-MM-RR HH12:MI:SSXFF AM'),null);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C004311
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."SYS_C004311" ON "HR"."TRN_CUSTOMERS" ("CUSTOMER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."SYS_C004312" ON "HR"."TRN_CUSTOMERS" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C004313
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."SYS_C004313" ON "HR"."TRN_CUSTOMERS" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C004314
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."SYS_C004314" ON "HR"."TRN_CUSTOMERS" ("USERNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
